...
//   const UserUpdate({super.key, required this.uid,required this.role});
//   final String uid;
//   final String role;
...
//     Auth.updateUser(data, context);
    
//   }

//   @override
//   void initState() {
//     FirebaseDatabase.instance.ref().child('user').child(widget.role).child(widget.uid).onValue.listen((event) async {
//       var data = event.snapshot.value as Map;

//       setState(() {
//         nameController.text = data['name'];
//         emailController.text = data['email'];
//         roleController = SingleValueDropDownController(data: DropDownValueModel(value: "${data['role']}", name: "${data['role']}"));
//       });
//     });
//     super.initState();
//   }
